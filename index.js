...
function getAverageGoals(getFinalsCb) {
   ...
   return (finals.reduce((first_ele, curr_ele )=> {
        return first_ele + curr_ele["Home Team Goals"] + curr_ele["Away Team Goals"]
    }, 0) /  finals.length).toFixed(2)


}
getAverageGoals(getFinals(fifaData))
// console.log("KFDJSKLFJDFJLJK", getFinals(fifaData))
